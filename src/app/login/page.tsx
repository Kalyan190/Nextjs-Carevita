          ...
          <div className="w-11/12 max-w-[600px] px-10 py-3 max-sm:px-4 rounded-3xl bg-white border-2 border-gray-100 max-sm:text-center">
            ...
            <div className="mt-4 max-sm:text-left">
              ...
              <div className="mt-4 flex flex-col gap-y-4">
                <button
                  className="cursor-pointer active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out transform py-2 bg-violet-500 rounded-xl text-white font-bold text-lg"
